...
extern void parallelProjectMatrix( const int width, const int height, const FLOAT64 xmin, const FLOAT64 xmax, const FLOAT64 ymin, const FLOAT64 ymax, Matrix xform );
extern void perspectiveProjectMatrix( const int width, const int height, const FLOAT64 xmin, const FLOAT64 xmax, const FLOAT64 ymin, const FLOAT64 ymax, const FLOAT64 d, Matrix xform );
