...
int main()
{
  ...
  eulerRotateMatrix( pZero, DEG2RAD( 30.0 ), DEG2RAD( 0.0 ), DEG2RAD( 0.0 ), euler );
  printf( "//-- euler pZero, 30°, 0°, 0° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pZero, 30°, 0°, 0°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pZero, DEG2RAD( 0.0 ), DEG2RAD( 45.0 ), DEG2RAD( 0.0 ), euler );
  printf( "//-- euler pZero, 0°, 45°, 0° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pZero, 0°, 45°, 0°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pZero, DEG2RAD( 0.0 ), DEG2RAD( 0.0 ), DEG2RAD( 60.0 ), euler );
  printf( "//-- euler pZero, 0°, 0°, 60° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pZero, 0°, 0°, 60°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pZero, DEG2RAD( 30.0 ), DEG2RAD( 45.0 ), DEG2RAD( 60.0 ), euler );
  printf( "//-- euler pZero, 30°, 45°, 60° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pZero, 30°, 45°, 60°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pHalf, DEG2RAD( 30.0 ), DEG2RAD( 0.0 ), DEG2RAD( 0.0 ), euler );
  printf( "//-- euler pHalf, 30°, 0°, 0° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pHalf, 30°, 0°, 0°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pHalf, DEG2RAD( 0.0 ), DEG2RAD( 45.0 ), DEG2RAD( 0.0 ), euler );
  printf( "//-- euler pHalf, 0°, 45°, 0° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pHalf, 0°, 45°, 0°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pHalf, DEG2RAD( 0.0 ), DEG2RAD( 0.0 ), DEG2RAD( 60.0 ), euler );
  printf( "//-- euler pHalf, 0°, 0°, 60° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pHalf, 0°, 0°, 60°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  eulerRotateMatrix( pHalf, DEG2RAD( 30.0 ), DEG2RAD( 45.0 ), DEG2RAD( 60.0 ), euler );
  printf( "//-- euler pHalf, 30°, 45°, 60° ----\n" );
  dumpMatrix( euler );

  matrixMultEachPoint( "(euler pHalf, 30°, 45°, 60°)", euler );

  printf( "\n//-----------------------------------------------------------------\n" );
  Matrix project;

  parallelProjectMatrix( 150, 100, 2.0, 8.0, -0.5, 3.5, project );
  printf( "//-- parallel project 150, 100, 2.0, 8.0, -0.5, 3.5 ----\n" );
  dumpMatrix( project );

  perspectiveProjectMatrix( 150, 100, -2.0, 2.0, -2.5, 2.5, 10.5, project );
